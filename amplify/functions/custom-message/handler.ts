    ...
    <html>
      <body style="font-family: Arial, sans-serif; background: #f8f4ec; color: #111827; padding: 24px;">
        <div style="max-width: 560px; margin: 0 auto; background: #ffffff; border-radius: 20px; padding: 24px; border: 1px solid #e5d6c3;">
          <p style="font-size: 12px; font-weight: 700; letter-spacing: 1px; text-transform: uppercase; color: #c2410c;">BarberFlow invitation</p>
          <h1 style="margin: 8px 0 12px; font-size: 28px;">Welcome to the team</h1>
          <p style="line-height: 1.6; color: #475569;">Your admin created your account. Open the app using the button below and your login form will be filled automatically.</p>
          ...
          <p style="margin: 0; color: #64748b; line-height: 1.6;">You will be asked to choose a new password the first time you log in.</p>
        </div>
      </body>
    </html>
  `;
